...
vector<vector<int>> ans;        // 2D array which will store permuted arrays
...
permute(a, 0);      // This is defined function(input is array and index from where permutations should be started)
